...
public class ModEntities {
        ...
        public static final EntityType<KamikazeRitualEntity> KAMIKAZE_RITUAL = Registry.register(
                        ...
                        FabricEntityTypeBuilder.<KamikazeRitualEntity>create(
                                        ...
                                        .trackedUpdateRate(2)
                                        .build());
        public static final EntityType<KineticBladeHitboxEntity> KINETIC_BLADE_HITBOX = Registry.register(
                        Registries.ENTITY_TYPE,
                        new Identifier(AnimeWitchery.MOD_ID, "kinetic_blade_hitbox"),
                        FabricEntityTypeBuilder
                                        .<KineticBladeHitboxEntity>create(SpawnGroup.MISC,
                                                        KineticBladeHitboxEntity::new)
                                        .dimensions(EntityDimensions.fixed(1.5f, 1.5f)) // size for hitbox
                                        .trackRangeBlocks(64)
                                        .trackedUpdateRate(1)
                                        .build());
        public static final EntityType<ResonantShieldEntity> RESONANT_SHIELD = Registry.register(Registries.ENTITY_TYPE,
                        new Identifier(AnimeWitchery.MOD_ID, "resonant_shield"),
                        FabricEntityTypeBuilder.<ResonantShieldEntity>create(SpawnGroup.MISC, ResonantShieldEntity::new)
                                        .dimensions(EntityDimensions.fixed(1.0f, 1.0f)).build());

        public static final EntityType<net.willowins.animewitchery.entity.custom.ResonantSparkEntity> RESONANT_SPARK = Registry
                        .register(Registries.ENTITY_TYPE,
                                        new Identifier(AnimeWitchery.MOD_ID, "resonant_spark"),
                                        FabricEntityTypeBuilder.<net.willowins.animewitchery.entity.custom.ResonantSparkEntity>create(
                                                        SpawnGroup.MISC,
                                                        net.willowins.animewitchery.entity.custom.ResonantSparkEntity::new)
                                                        .dimensions(EntityDimensions.fixed(0.25f, 0.25f)) // Small
                                                                                                          // projectile
                                                        .trackRangeBlocks(64)
                                                        .trackedUpdateRate(10)
                                                        .build());
