...
import net.willowins.animewitchery.item.armor.client.ObeliskArmorRenderer;
...
public final class ObeliskArmorItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);

    public ObeliskArmorItem(ArmorMaterial armorMaterial, Type type, Settings properties) {
        ...
        consumer.accept(new RenderProvider() {
            ...
            public BipedEntityModel<LivingEntity> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, BipedEntityModel<LivingEntity> original) {
                if (this.renderer == null) {
                    this.renderer = new ObeliskArmorRenderer();
                }
