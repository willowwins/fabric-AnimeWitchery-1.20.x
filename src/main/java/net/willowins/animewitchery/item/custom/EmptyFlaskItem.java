        ...
        if (hitResult.getType() == HitResult.Type.MISS) {
            ...
            if (hitResult.getType() == HitResult.Type.BLOCK) {
                ...
                if (world.getFluidState(blockPos).isIn(FluidTags.WATER)) {
                    ...
                    ItemStack filledStack = PotionUtil.setPotion(new ItemStack(ModItems.POTION_FLASK), Potions.WATER);
                    return TypedActionResult.success(this.fill(itemStack, user, filledStack), world.isClient());
                }
            }
