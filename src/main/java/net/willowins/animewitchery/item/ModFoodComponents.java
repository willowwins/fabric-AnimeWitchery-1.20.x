...
public class ModFoodComponents {
    ...
    public static final FoodComponent LEMON_TART = new FoodComponent.Builder().hunger(8).alwaysEdible().saturationModifier(1.5f)
            .statusEffect(new StatusEffectInstance(StatusEffects.HASTE,1000,0),100f).build();

    public static final FoodComponent STRAWBERRY_TART = new FoodComponent.Builder().hunger(8).alwaysEdible().saturationModifier(1.5f)
