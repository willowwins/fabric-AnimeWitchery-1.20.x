...
public class ModBlocks {
        ...
        public static final Block TRANSMUTATION_PYRE = registerBlock("transmutation_pyre",
                        new TransmutationPyreBlock(FabricBlockSettings.copyOf(Blocks.NETHER_BRICKS)));
