...
public class BlockMinerScreen extends HandledScreen<BlockMinerScreenHandler> {
    private static final Identifier TEXTURE = new Identifier("minecraft", "textures/gui/container/dispenser.png");

    private final PlayerInventory playerInventory;

    public BlockMinerScreen(BlockMinerScreenHandler handler, PlayerInventory inventory, Text title) {
